<?php
/**
 * Native Door Configuration Manager
 *
 * Manages configuration for native Linux door games from config/nativedoors.json
 *
 * @package BinktermPHP
 */
...
class NativeDoorConfig
{
    private static ?array $config = null;
    private static bool $loaded = false;

    /**
     * Get path to nativedoors.json config file
     */
    private static function getConfigPath(): string
    {
        ...
        return $basePath . '/config/nativedoors.json';
    }
    ...
    /**
     * Check if native door system is enabled (config file exists)
     */
