...
|----------------------------------------|-------------|------------|
| [1.8.3](docs/UPGRADING_1.8.3.md)       | TBD         | MRC Chat WebDoor, Appearance system & shells, Gemini Capsule Hosting, Gemini echo area exposure, Markdown compose editor, netmail file attachments, file share links, friendly share URLs, address book crashmail preference, crashmail DNS fallback & immediate delivery, scrollable message reader, echomail bulk mark-as-read |
