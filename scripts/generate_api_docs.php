...
function generateMarkdown(array $sections): string
{
    ...
    $out[] = "";
    $out[] = "```http";
    $out[] = "POST /api/auth/login";
    $out[] = "Content-Type: application/json";
    $out[] = "";
    $out[] = '{"username": "youruser", "password": "yourpassword"}';
    $out[] = "```";
    $out[] = "";
    $out[] = "Response:";
    $out[] = "";
    ...
    $out[] = '{';
    $out[] = '  "success": true,';
    $out[] = '  "csrf_token": "abc123...",';
    $out[] = '  "user": { "id": 1, "username": "youruser", "is_admin": false }';
    $out[] = '}';
    $out[] = "```";
    $out[] = "";
    $out[] = "The response also sets a `binktermphp_session` cookie. Include it in all subsequent requests.";
    $out[] = "";
    $out[] = "**2. Make an authenticated request**";
    $out[] = "";
    $out[] = "```http";
    $out[] = "GET /api/messages/echomail?area_id=1&limit=25";
    $out[] = "Cookie: binktermphp_session=<session-cookie>";
    $out[] = "```";
    $out[] = "";
    $out[] = "For state-changing requests (POST, PUT, DELETE), also include the CSRF token:";
    $out[] = "";
    $out[] = "```http";
    $out[] = "POST /api/messages/echomail";
    $out[] = "Cookie: binktermphp_session=<session-cookie>";
    $out[] = "X-CSRF-Token: abc123...";
    $out[] = "Content-Type: application/json";
    $out[] = "";
    $out[] = '{"area_id": 1, "subject": "Hello", "body": "Message body"}';
    $out[] = "```";
    $out[] = "";
    $out[] = "**Error responses** use a structured format:";
    $out[] = "";
    $out[] = "```json";
    $out[] = '{';
    $out[] = '  "error": "Invalid credentials",';
    $out[] = '  "error_code": "errors.auth.invalid_credentials"';
    $out[] = '}';
    $out[] = "```";
    $out[] = "";
