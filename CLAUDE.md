...
- Use **Pattern 2** (callable) for migrations needing helper functions, loops, or complex logic
 ...
 - **Documentation index**: When adding a new documentation file to `docs/` (excluding `docs/proposals/`), update `docs/index.md` to include it in the appropriate section in operational priority order.
