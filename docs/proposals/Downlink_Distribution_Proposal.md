...
**SUPERSEDED:** This proposal has been unified with `docs/proposals/PointRouting_Proposal.md` into `docs/proposals/HubPointSystemJuly2026.md`, which additionally adds FidoNet point (`boss/point` address) support to the same distribution mechanism. Refer to `docs/proposals/HubPointSystemJuly2026.md` for current design work.
