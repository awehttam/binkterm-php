...
├── api.php               # All backend logic (API endpoints, database, validation)
├── css/
│   └── cwn.css          # Styles
├── js/
│   ├── cwn.js           # Main application logic
│   └── map.js           # Map functionality
└── assets/
    └── icons/           # Network type icons
```
...
```
┌────────────────────────────────────────────────────┐
│  Community Wireless Node List        Credits: 145  │
├────────────────────────────────────────────────────┤
│                                                     │
│  [Search Location...]  [📍 Use My Location]        │
│  [Filter: All Types ▼]  [Radius: 5km ▼]           │
│                                                     │
│  ┌──────────────────────────────────────────────┐  │
│  │                                              │  │
│  │          Interactive Map                     │  │
...
│  ┌──────────────────────────────────────────────┐  │
│  │ 📡 MeshNet_Downtown                          │  │
│  │    Downtown mesh with local services         │  │
│  │    Distance: 0.5 km • Added: 2 days ago     │  │
│  └──────────────────────────────────────────────┘  │
│  ┌──────────────────────────────────────────────┐  │
│  │ 📡 Community_WiFi_Park                       │  │
│  │    Free WiFi with local portal               │  │
│  │    Distance: 1.2 km • Added: 1 week ago     │  │
│  └──────────────────────────────────────────────┘  │
└────────────────────────────────────────────────────┘
```
...
│                                     │
│  📝 Description:                    │
│  Downtown mesh network with local   │
│  file sharing, chat services, and   │
│  community bulletin board.          │
│                                     │
│  🔐 Password: (none - open network) │
│                                     │
│  ℹ️ Submitted by: user123@YourBBS   │
│  📅 Added: Jan 15, 2026             │
...
│  [_____________________________]    │
│  ☐ This network is open/public      │
│                                     │
│  💰 You will earn 3 credits         │
│                                     │
│  [Cancel]  [Submit Network]         │
│                                     │
└─────────────────────────────────────┘
```
